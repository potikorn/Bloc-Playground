...
import 'package:bloc_playground/features/weather/models/models.dart';
...
void main() {
  ...
  group('WeatherCubit', () {
    ...
    group('fetchWeather', () {
      ...
      blocTest<WeatherCubit, WeatherState>(
        'emits nothing with correct city',
        build: () => weatherCubit,
    ...
    group('refreshWeather', () {
      ...
      blocTest<WeatherCubit, WeatherState>(
        'emits noting when location is null',
        build: () => weatherCubit,
        act: (cubit) => cubit.refreshWeather(),
        expect: () => <WeatherState>[],
        verify: (_) {
